    ...
    if(sessionStorage.getItem("user")==null)
        {
         ...
         { 
           ...
           document.getElementById("profile_username").innerHTML=atob(obj_data.username);//navigastion image code

           //profile picture coding so with navigadion war
           ...
           if(localStorage.getItem(user_email+"image")!=null)
            ...
            reader.onload=function()
            {
                ...
                next_btn.onclick=function()
                {
                    ...
                    var page_cover=document.getElementById("container");
                    page_cover.style.display="none"
                    window.location=location.href;//load the crent url
                }
            }
        }
